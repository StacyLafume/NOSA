...
import "../missio-html/template/missio/style/css/bootstrap.min.css"
...
const html =` <div class="content-wrapper">
<nav class="navbar wide bg-light text-uppercase navbar-expand-lg">
  <div class="container-fluid flex-row justify-content-center">
    <div class="navbar-header">
      <div class="navbar-brand"><a href="index.html"><img src="#" srcset="style/images/logo2.png 1x, style/images/logo2@2x.png 2x" alt="" /></a></div>
  ...
  <div id="slider2" class="rev_slider fullscreenbanner dark-wrapper" data-version="5.4.8">
    <ul>
      <li data-index="rs-26" data-transition="fade">
        <img src="style/images/dummy.png" alt="" />
  ...
  <div class="container inner">
    <div class="row d-flex align-items-center">
      <div class="col-lg-6 pr-35 pr-sm-15">
        <figure class="rounded"><img src="style/images/art/about4.jpg" alt=""></figure>
      </div>
      <!-- /column -->
  ...
  <div class="container inner">
    ...
    <div id="cube-inline-7" class="cbp cbp-inline-top cube-inline-7">
      <div class="cbp-item text-center nature">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post1.html" class="cbp-singlePageInline"><img src="style/images/art/v1.jpg" alt="" /></a>
      ...
      <div class="cbp-item text-center ocean">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post2.html" class="cbp-singlePageInline"><img src="style/images/art/v2.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <!--/.cbp-item -->
      <div class="cbp-item text-center nature">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post3.html" class="cbp-singlePageInline"><img src="style/images/art/v3.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <!--/.cbp-item -->
      <div class="cbp-item text-center ocean">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post4.html" class="cbp-singlePageInline"><img src="style/images/art/v4.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <!--/.cbp-item -->
      <div class="cbp-item text-center nature">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post5.html" class="cbp-singlePageInline"><img src="style/images/art/v5.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <div class="cbp-item text-center travel">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post6.html" class="cbp-singlePageInline"><img src="style/images/art/v6.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <!--/.cbp-item -->
      <div class="cbp-item text-center travel">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post7.html" class="cbp-singlePageInline"><img src="style/images/art/v7.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <!--/.cbp-item -->
      <div class="cbp-item text-center travel">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post8.html" class="cbp-singlePageInline"><img src="style/images/art/v8.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
      ...
      <div class="cbp-item text-center safari">
        <figure class="overlay overlay4 rounded"><a href="ajax/portfolio7-post9.html" class="cbp-singlePageInline"><img src="style/images/art/v9.jpg" alt="" /></a>
          <figcaption class="d-flex">
            <div class="align-self-center mx-auto">
...
<!-- /.wrapper -->
<div class="wrapper image-wrapper bg-image inverse-text" data-image-src="style/images/art/bg6.jpg">
...
<div class="wrapper white-wrapper">
  <div class="container inner">
    ...
    <div class="cube-carousel cbp grid-view">
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb28.jpg" alt="" /></a>
          <figcaption>
      ...
      <!-- /.post -->
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb29.jpg" alt="" /></a>
          <figcaption>
            <h5 class="text-uppercase from-top mb-0">Read More</h5>
          </figcaption>
        </figure>
      ...
      <!-- /.post -->
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb30.jpg" alt="" /></a>
          <figcaption>
            <h5 class="text-uppercase from-top mb-0">Read More</h5>
          </figcaption>
        </figure>
      ...
      <!-- /.post -->
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb31.jpg" alt="" /></a>
          <figcaption>
            <h5 class="text-uppercase from-top mb-0">Read More</h5>
          </figcaption>
        </figure>
      ...
      <!-- /.post -->
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb32.jpg" alt="" /></a>
          <figcaption>
            <h5 class="text-uppercase from-top mb-0">Read More</h5>
          </figcaption>
        </figure>
      ...
      <!-- /.post -->
      <div class="cbp-item">
        <figure class="overlay overlay1 mb-30 rounded"><a href="#"> <img src="style/images/art/gb33.jpg" alt="" /></a>
          <figcaption>
            <h5 class="text-uppercase from-top mb-0">Read More</h5>
          </figcaption>
        </figure>
...
const Home = () => {
    return (
        <>
            ...
            {parse(html)}
            {/* <ScriptTag isHydrating={true} type="text/javascript" src="../missio-html/template/missio/style/js/jquery.min.js" /> */}
        </>
    )
}
